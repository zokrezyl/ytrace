...
function(do_fetch)
  ...
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git rev-parse "${ref}^0"
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
...
execute_process(
  COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git show-ref "v1.14.1"
  WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
...
execute_process(
  COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git status --porcelain
  WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
    COMMAND_ERROR_IS_FATAL ANY
    ${maybe_show_command}
  )
  ...
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git rebase --abort
      WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
      ${maybe_show_command}
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git stash pop --index --quiet
          WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
          ${maybe_show_command}
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/misi/work/my/ytrace/build/_deps/spdlog-src'."
    ...
    execute_process(
      COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git reset --hard --quiet
      WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
      ${maybe_show_command}
    )
    execute_process(
      COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git stash pop --quiet
      WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
      RESULT_VARIABLE error_code
      ${maybe_show_command}
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/spdlog-src"
        ${maybe_show_command}
      )
      execute_process(
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/misi/work/my/ytrace/build/_deps/spdlog-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git"
            --git-dir=.git 
