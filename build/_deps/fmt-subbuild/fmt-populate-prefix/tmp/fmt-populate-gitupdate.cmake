...
function(do_fetch)
  ...
  execute_process(
    ...
    WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/fmt-src"
...
execute_process(
  COMMAND "/home/misi/.local/state/nix/profiles/dev/profile/bin/git" --git-dir=.git show-ref "10.2.1"
  WORKING_DIRECTORY "/home/misi/work/my/ytrace/build/_deps/fmt-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/misi/work/my/ytrace/build/_deps/fmt-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/misi/work/my/ytrace/build/_deps/fmt-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
